...
pub fn oracle_lookup(board: &Board) -> bool {
	...
	|| (minor_piece_king(board, Color::White) && knight_lone_king(board, Color::Black) || minor_piece_king(board, Color::Black) && knight_lone_king(board, Color::White))
	|| (minor_piece_king(board, Color::White) && bishop_lone_king(board, Color::Black) || minor_piece_king(board, Color::Black) && bishop_lone_king(board, Color::White))
}
