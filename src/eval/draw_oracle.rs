...
pub fn oracle_lookup(board: &Board) -> bool {
	...
	|| ((bishop_pair_lone_king(board, Color::White) || white_only_king) && bishop_lone_king(board, Color::Black, None))
	|| ((bishop_pair_lone_king(board, Color::Black) || black_only_king) && bishop_lone_king(board, Color::White, None))
