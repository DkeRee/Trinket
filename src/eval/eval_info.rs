...
pub const KNIGHT_MOBILITY: [Score; 9] = [
    S!(  -8,    4), S!(   1,    0), S!(  -1,   -1), S!(   2,    1), S!(   4,    3), S!(  -2,   -1), S!(  -1,    0), S!(  -1,    0), 
    S!(   6,    1), 
];
...
pub const ROOK_MOBILITY: [Score; 15] = [
    S!(   0,    0), S!(   0,    0), S!(   0,    0), S!(   0,    0), S!(   0,    0), S!(-151,  -82), S!( -16,  -15), S!(   1,    0), 
...
pub const VIRTUAL_MOBILITY: [Score; 28] = [
    S!(   0,    0), S!(  10,   10), S!(  11,   12), S!(  11,    8), S!(   8,    5), S!(  11,    5), S!(   3,    4), S!(   2,   -2), 
...
pub const P: [Score; 64] = [
    ...
    S!( -19,    3), S!( -11,    3), S!(  -7,   -8), S!( -14,   14), S!(   6,    1), S!(   5,    4), S!(  16,    1), S!(   6,  -11), 
...
pub const N: [Score; 64] = [
    ...
    S!( -39,  -40), S!( -33,  -22), S!( -20,  -13), S!( -17,   -9), S!( -19,   -4), S!(   1,    0), S!( -22,  -34), S!( -23,  -25), 
...
pub const B: [Score; 64] = [
    ...
    S!(   8,  -39), S!(  -5,   -5), S!(  15,   -9), S!(  -8,   -6), S!(   0,    3), S!(  10,   -1), S!(  13,  -10), S!( -11,  -10), 
...
pub const R: [Score; 64] = [
    ...
    S!( -40,    8), S!( -14,    3), S!( -24,    9), S!(  -3,    5), S!(   2,   -1), S!(   1,    0), S!(   6,    2), S!(   0,   -3), 
    S!(  -4,   -5), S!(  25,   -1), S!(   4,    9), S!(  11,   10), S!(  -2,   -1), S!(  -1,    0), S!(   6,    4), S!(  24,    0), 
    S!(   1,   -1), S!(  13,   20), S!(  20,   16), S!(  15,   11), S!(  -1,    0), S!(  -1,    0), S!(   0,    0), S!(  11,    6), 
    S!(  11,   10), S!(  10,   10), S!(  10,   10), S!(  10,   10), S!(  20,   15), S!(  29,   18), S!(  14,   14), S!(   5,    5), 
...
pub const K: [Score; 64] = [
    ...
    S!( -16,   -4), S!( -29,    7), S!( -25,   29), S!( -38,   40), S!( -28,   52), S!( -16,   43), S!(   9,   37), S!( -17,  -18), 
